...
\caption{Decay prediction results. (a) Within-task AUC comparing the full trajectory (5-fold cross-validated $0.75 \pm 0.02$) against snapshot and final-layer baselines. (b) Cross-task transfer matrix. (c) Cross-model transfer matrix.}
